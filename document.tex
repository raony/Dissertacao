...
Os dois tipos são complementares e \{stephenson, 1989 rethinking centrality,
apud wasserman\} mais de uma métrica devem ser combinadas, por esta razão, já é
possível derivarmos uma primeira restrição sobre a representação da rede:
...
representa diretamente a quantidade de caminhos que chegam ou partem 

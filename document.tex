...
Antes de entrar em detalhes sobre como as interações são combinadas, vamos rever
alguns conceitos da mineração de dados. \textit{Knowledge discovery} é o
processo maior "... não-trivial de identificar, em dados, padrões
válidos, novos, potencialmente úteis e ultimamente compreensíveis"
\cite{Fayyad1996} e mineração de dados é uma de suas etapas. Apesar dos
algoritmos para aprendizagem de máquina e mineração de dados estarem bem
consolidados \cite{Cios2005}, a maioria deles não foram feitos para dados
...
Seguindo com o nosso objetivo de mensurar redes sociais digitais para a análise
de influência, devemos ter em mente que como processo de mineração de dados, um
método se faz necessário. Para isso, utilizaremos o método de 6 passos descritos
em \cite{Cios2005} e que consiste em:

\begin{description}
\item[1. Entendendo o domínio do problema]Neste passo devemos determinar os
objetivos da mineração e aprender sobre as possíveis técnicas conhecidas para
alcançá-los.
...
processo depende; Ela geralmente consome metade de todo os esforço da mineração.
...
\item[4. Mineração dos dados]Este é outro passo crucial para todo o processo.

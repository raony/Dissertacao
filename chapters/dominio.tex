...
prescritores restringem ou potencializam a força existente. Dentre os
prescritores está a homofilia, o que quer dizer que a similaridade entre os
atores tem, de fato, alguma influencia sobre a conexão, mas é a intensidade,
duração, intimidade e reciprocidade da interação que indicam a sua força. Dessas
quatro dimensões iniciais (tempo, intensidade, intimidade, reciprocidade),
acrescentaram-se nove outras no decorrer de três décadas de pesquisa. Na
\tabref{tab:resumao} temos um apanhado dos indicadores propostos na literatura.
...
A partir de então sugerimos alguns critérios que deverão ser considerados na
escolha das ferramentas de mineração que serão utilizadas no processo de análise
de influência:
...
O próximo passo será avaliar como coletar os dados e determinar sua validade
para o uso no processo de mineração.

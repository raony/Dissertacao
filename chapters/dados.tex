...
\subsection{Notação}
\label{sec:dados:notacao}
Para fins de notação, \Vtp{i}{j} representa o total de atenção cedida do
ator $n_i$ para o ator $n_j$. Esse total, como foi apresentado na
\secref{sec:teoria_atencao}, é composto por toda a atenção direta, residual e
...
particular $l_k$ usaremos a notação \vdp{i}{j}{k} e só será diferente de zero se
...
Da mesma forma, \vrp{i}{j}{k} representa a atenção residual cedida por $n_i$ a
...
transitiva de $n_i$ para $n_j$, representada por \vtrp{i}{j}{q}. 

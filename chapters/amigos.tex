...
\secref{sec:teoria_atencao}, com isso obtivemos a integração de quatro tipos
de interação textuais. Os quatro medianeiros textuais utilizados e
classificados de acordo com a tipologia apresentada na \secref{sec:tipologia}
são:
...
formadas a partir do algoritmo aprensentado em \secref{sec:formalizacao},
...
Como o sistema mantém um registro de quem leu ou não um determinado tópico ou
história, ajustamos o parâmetro $\omega$ (ver a \defref{def:atedireta}) para 0,
...
quadrática (\emph{QAP}). Como foi mostrado na \secref{sec:criterios}, redes com
alto grau de sobreposição podem ser descartadas uma em favor da outra para
reduzir o conjunto a ser analisado na próxima etapa. Na \tabref{ap:tab:qap} temos
...
Pelo custo computacional das métricas escolhidas, temos que o tempo utilizado
...
A \tabref{ap:tab:comu_prat} nos mostra que esse não é o caso,
